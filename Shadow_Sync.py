...
if __name__ == "__main__":
    ...
    try:
        ...
        event_handler = MyHandler(db_connection=db_connection, disallowed_extensions=disallowed_extensions)

                
        print(f"Monitoring {directory_to_monitor} and its subdirectories every 1 minute. Press Ctrl+C key to stop.")
        monitor_directory(directory_to_monitor, db_connection)
